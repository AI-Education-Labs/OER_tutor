...
from backend.database import get_user_document_by_id
...
async def get_current_user(token: str = Depends(oauth2_scheme)):
    ...
    try:
        ...
        print("Fetching user for ID:", user_id)
        user_dict = await get_user_document_by_id(user_id)  # Replace with your DB fetching logic
